...
test(
  "prepareContext - Exhaustive Config: Optional typeScript fields",
  async () => {
...
test(
  "prepareContext - Exhaustive Config: Invalid fields with defaults (.catch)",
  async () => {
    const tempDir = makeTempDirSync();
...
test(
  "prepareContext - Exhaustive Resource: Markdown with complex metadata",
  async () => {
    const tempDir = makeTempDirSync();
...
test(
  "prepareContext - Exhaustive Tool: inputSchema and outputSchema validation",
  async () => {
    const tempDir = makeTempDirSync();
...
test(
  "prepareContext - Exhaustive Tool: Name transformation to snake_case",
  async () => {
    const tempDir = makeTempDirSync();
    const toolsDir = join(tempDir, "tools");
