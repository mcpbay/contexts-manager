...
test(
  "MCPContext - Exhaustive Execution: Tool with complex input validation",
  async () => {
...
test(
  "MCPContext - Exhaustive Execution: Tool returning non-object",
  async () => {
    const tempDir = makeTempDirSync();
    const contextDir = join(tempDir, "context");
...
test(
  "MCPContext - Exhaustive Execution: Resource returning non-string",
  async () => {
    const tempDir = makeTempDirSync();
    const contextDir = join(tempDir, "context");
